  ...
  <Container>
    ...
    <Row>
      ...
      <Col lg="6">
        ...
        <p>During all these years I got well versed in many languages and technologies, such as PHP, Java, Javascript, C, SQL, HTML and CSS. It is also crucial to know widely used frameworks/toolkits, so I have a grasp on React, AngularJS, Lumen, Bootstrap among others; </p>
    ...
    <Row>
      <Col lg='12'>
        ...
        <p>Next step, I needed to know how to speak English. After hard work and some unsuccessful attempts, I managed to pass on the IELTS Exam with an overall band of 8.0 with no skill below 7.0. That was one of the requirements to be entitled to an Australian Skilled Visa.</p>
